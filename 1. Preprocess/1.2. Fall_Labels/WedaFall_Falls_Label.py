...
diretorio_raiz = r"C:\Users\Vanilson Fula\Desktop\Tese_Soft\Scripts_Datasets\Dados\WEDA"

# Lista de nomes das atividades de interesse
atividades_interesse = ['Activity13', 'Activity14', 'Activity15', 'Activity16', 'Activity17', 'Activity18', 'Activity19', 'Activity20']
...
def find_window_indices(dados, limiar=0.5, duracao_janela=3.0):
